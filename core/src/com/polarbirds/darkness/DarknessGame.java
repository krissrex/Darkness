...
import com.polarbirds.darkness.graphics.CustomShaderProvider;
...
public class DarknessGame extends Game {
    ...
    public void create() {
        ...
        spriteBatch = new SpriteBatch(1000, Shaders.default_shader.default_shader);
        modelBatch = new ModelBatch(new CustomShaderProvider());

        Shaders.default_shader.default_shader.setUniformf("time", System.currentTimeMillis()%6.28f);
